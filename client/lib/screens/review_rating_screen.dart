    ...
    return Row(
      children: [
        ...
        Expanded(
          ...
          child: Column(
            children: [
              TProgressRatingIndicator(text: '5', value: 1.0,),
              TProgressRatingIndicator(text: '4', value: 0.8,),
              TProgressRatingIndicator(text: '3', value: 0.6,),
              TProgressRatingIndicator(text: '2', value: 0.4,),
              TProgressRatingIndicator(text: '1', value: 0.2,)
            ],
          ),
        )
      ],
