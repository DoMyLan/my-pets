...
class VideoApp extends StatefulWidget {
  ...
  const VideoApp({super.key, required this.videoPost, required this.back});
  @override
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          CircleAvatar(
                            radius: 25,
                            backgroundImage: NetworkImage(widget.videoPost
                          ...
                          GestureDetector(
                            ...
                            child: Icon(
                              Icons.favorite,
                              color:
                                  _isFavorited ? Colors.red : Colors.grey[300],
                              size: 50,
                            ),
                          ),
                          const SizedBox(height: 20),
